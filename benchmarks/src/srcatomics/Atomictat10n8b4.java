...
bench at 2019-03-11 17:51:46.848136
...
public class Atomictat10n8b4 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat10n8b4 p = new ParallelForAtomictat10n8b4(150, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat10n8b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat10n8b4 (int it, AtomicInteger sh) { 
