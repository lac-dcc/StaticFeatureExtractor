...
bench at 2019-03-11 17:51:50.739917
...
public class Atomictat15n4b4 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat15n4b4 p = new ParallelForAtomictat15n4b4(300, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat15n4b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat15n4b4 (int it, AtomicInteger sh) { 
