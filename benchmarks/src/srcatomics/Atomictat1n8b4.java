...
bench at 2019-03-11 17:51:45.540847
...
public class Atomictat1n8b4 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat1n8b4 p = new ParallelForAtomictat1n8b4(150, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat1n8b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat1n8b4 (int it, AtomicInteger sh) { 
