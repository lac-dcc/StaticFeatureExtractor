...
bench at 2019-03-11 17:51:54.110694
...
public class Atomictat10n6b2 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat10n6b2 p = new ParallelForAtomictat10n6b2(200, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat10n6b2 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat10n6b2 (int it, AtomicInteger sh) { 
