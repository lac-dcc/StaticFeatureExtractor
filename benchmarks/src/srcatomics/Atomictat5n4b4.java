...
bench at 2019-03-11 17:51:50.222659
...
public class Atomictat5n4b4 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat5n4b4 p = new ParallelForAtomictat5n4b4(300, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat5n4b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat5n4b4 (int it, AtomicInteger sh) { 
