...
bench at 2019-03-11 17:51:44.502359
...
public class Atomictat04n8b4 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat04n8b4 p = new ParallelForAtomictat04n8b4(150, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat04n8b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat04n8b4 (int it, AtomicInteger sh) { 
