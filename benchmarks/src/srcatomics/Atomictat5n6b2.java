...
bench at 2019-03-11 17:51:53.852272
The for construct iteration size is8192
with percentage of atomic operations 5.0
...
public class Atomictat5n6b2 {
   ...
   public static void main (String[] args) {
       ...
       System.err.println("percentage of atomic operations is 5.0\n");

       double time;
       long start = System.nanoTime();
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat5n6b2 p = new ParallelForAtomictat5n6b2(200, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat5n6b2 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat5n6b2 (int it, AtomicInteger sh) { 
