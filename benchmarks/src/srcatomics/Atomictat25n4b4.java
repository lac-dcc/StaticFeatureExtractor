...
bench at 2019-03-11 17:51:49.964152
...
public class Atomictat25n4b4 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat25n4b4 p = new ParallelForAtomictat25n4b4(300, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat25n4b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat25n4b4 (int it, AtomicInteger sh) { 
