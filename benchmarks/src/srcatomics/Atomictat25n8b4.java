...
bench at 2019-03-11 17:51:46.324366
...
public class Atomictat25n8b4 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat25n8b4 p = new ParallelForAtomictat25n8b4(150, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat25n8b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat25n8b4 (int it, AtomicInteger sh) { 
