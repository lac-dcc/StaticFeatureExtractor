...
bench at 2019-03-11 17:51:54.373550
...
public class Atomictat15n6b2 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat15n6b2 p = new ParallelForAtomictat15n6b2(200, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat15n6b2 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat15n6b2 (int it, AtomicInteger sh) { 
