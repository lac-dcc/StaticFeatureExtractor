...
bench at 2019-03-11 17:51:52.555390
...
public class Atomictat09n6b2 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat09n6b2 p = new ParallelForAtomictat09n6b2(200, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat09n6b2 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat09n6b2 (int it, AtomicInteger sh) { 
