...
bench at 2019-03-11 17:51:47.629562
The for construct iteration size is8192
with percentage of atomic operations 0.2
...
public class Atomictat02n4b4 {
   ...
   public static void main (String[] args) {
       ...
       System.err.println("percentage of atomic operations is 0.2\n");

       double time;
       long start = System.nanoTime();
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat02n4b4 p = new ParallelForAtomictat02n4b4(300, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat02n4b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat02n4b4 (int it, AtomicInteger sh) { 
