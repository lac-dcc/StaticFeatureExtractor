...
bench at 2019-03-11 17:51:44.762733
...
public class Atomictat05n8b4 {
   ...
   public static void main (String[] args) {
       ...
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat05n8b4 p = new ParallelForAtomictat05n8b4(150, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat05n8b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat05n8b4 (int it, AtomicInteger sh) { 
