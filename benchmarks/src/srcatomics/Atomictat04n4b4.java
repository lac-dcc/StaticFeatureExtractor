...
bench at 2019-03-11 17:51:48.147375
The for construct iteration size is8192
with percentage of atomic operations 0.4
...
public class Atomictat04n4b4 {
   ...
   public static void main (String[] args) {
       ...
       System.err.println("percentage of atomic operations is 0.4\n");

       double time;
       long start = System.nanoTime();
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat04n4b4 p = new ParallelForAtomictat04n4b4(300, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat04n4b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat04n4b4 (int it, AtomicInteger sh) { 
