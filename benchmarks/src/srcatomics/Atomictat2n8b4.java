...
bench at 2019-03-11 17:51:46.063929
The for construct iteration size is8192
with percentage of atomic operations 2.0
...
public class Atomictat2n8b4 {
   ...
   public static void main (String[] args) {
       ...
       System.err.println("percentage of atomic operations is 2.0\n");

       double time;
       long start = System.nanoTime();
       for (int i = 0; i < NTHREADS; i++) {
          ParallelForAtomictat2n8b4 p = new ParallelForAtomictat2n8b4(150, shared);
          executor.submit(p);
       }
       executor.shutdown();
...
class ParallelForAtomictat2n8b4 implements Runnable { 
    int iterationsPerThread; 
    AtomicInteger shared; 
    int op1, op2; 
 
    ParallelForAtomictat2n8b4 (int it, AtomicInteger sh) { 
